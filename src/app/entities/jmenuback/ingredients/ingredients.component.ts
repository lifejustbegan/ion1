...
export class IngredientsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.ingredientsService
                ...
                .subscribe(
                    (res: HttpResponse<IIngredients[]>) => this.paginateIngredients(res.body, res.headers),
    ...
    registerChangeInIngredients() {
        this.eventSubscriber = this.eventManager.subscribe('ingredientsListModification', response => this.reset());
    }
    ...
    protected paginateIngredients(data: IIngredients[], headers: HttpHeaders) {
