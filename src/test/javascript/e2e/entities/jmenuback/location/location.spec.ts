...
describe('Location e2e test', () => {
    ...
    it('should load Locations', async () => {
        ...
        expect(await locationComponentsPage.getTitle()).to.eq('ionApp.jmenubackLocation.home.title');
    });
    ...
    it('should load create Location page', async () => {
        ...
        expect(await locationUpdatePage.getPageTitle()).to.eq('ionApp.jmenubackLocation.home.createOrEditLabel');
    ...
    it('should create and save Locations', async () => {
        ...
        await locationComponentsPage.clickOnCreateButton();
        await promise.all([
            locationUpdatePage.setAddress1Input('address1'),
            locationUpdatePage.setAddress2Input('address2'),
            ...
            locationUpdatePage.employeeSelectLastOption(),
            locationUpdatePage.businessSelectLastOption()
        ]);
        expect(await locationUpdatePage.getAddress1Input()).to.eq('address1');
        expect(await locationUpdatePage.getAddress2Input()).to.eq('address2');
    ...
    it('should delete last Location', async () => {
        ...
        expect(await locationDeleteDialog.getDialogTitle()).to.eq('ionApp.jmenubackLocation.delete.question');
