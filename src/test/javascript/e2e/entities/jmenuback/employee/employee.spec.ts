...
describe('Employee e2e test', () => {
    ...
    it('should load Employees', async () => {
        ...
        expect(await employeeComponentsPage.getTitle()).to.eq('ionApp.jmenubackEmployee.home.title');
    });
    ...
    it('should load create Employee page', async () => {
        ...
        expect(await employeeUpdatePage.getPageTitle()).to.eq('ionApp.jmenubackEmployee.home.createOrEditLabel');
    ...
    it('should create and save Employees', async () => {
        ...
        await promise.all([
            ...
            employeeUpdatePage.setMiddleNameInput('middleName'),
            employeeUpdatePage.setDobInput('dob'),
            ...
            employeeUpdatePage.setHourlyRateInput('5'),
            employeeUpdatePage.setTipInput('5'),
            employeeUpdatePage.setStatusInput('status'),
            // employeeUpdatePage.scheduleSelectLastOption(),
            employeeUpdatePage.businessSelectLastOption()
        ]);
        ...
        expect(await employeeUpdatePage.getMiddleNameInput()).to.eq('middleName');
        expect(await employeeUpdatePage.getDobInput()).to.eq('dob');
        ...
        expect(await employeeUpdatePage.getHourlyRateInput()).to.eq('5');
        expect(await employeeUpdatePage.getTipInput()).to.eq('5');
        expect(await employeeUpdatePage.getStatusInput()).to.eq('status');
    ...
    it('should delete last Employee', async () => {
        ...
        expect(await employeeDeleteDialog.getDialogTitle()).to.eq('ionApp.jmenubackEmployee.delete.question');
