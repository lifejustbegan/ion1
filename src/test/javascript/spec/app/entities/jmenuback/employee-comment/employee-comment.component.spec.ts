...
import { EmployeeCommentComponent } from 'app/entities/jmenuback/employee-comment/employee-comment.component';
...
describe('Component Tests', () => {
    describe('EmployeeComment Management Component', () => {
        let comp: EmployeeCommentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EmployeeCommentComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.employeeComments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
