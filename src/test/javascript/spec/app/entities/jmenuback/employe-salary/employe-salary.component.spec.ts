...
import { EmployeSalaryComponent } from 'app/entities/jmenuback/employe-salary/employe-salary.component';
...
describe('Component Tests', () => {
    describe('EmployeSalary Management Component', () => {
        let comp: EmployeSalaryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EmployeSalaryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.employeSalaries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
