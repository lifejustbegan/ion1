...
import { MenuTypesComponent } from 'app/entities/jmenuback/menu-types/menu-types.component';
...
describe('Component Tests', () => {
    describe('MenuTypes Management Component', () => {
        let comp: MenuTypesComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MenuTypesComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.menuTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
