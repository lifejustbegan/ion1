...
import { HappyHourComponent } from 'app/entities/jmenuback/happy-hour/happy-hour.component';
...
describe('Component Tests', () => {
    describe('HappyHour Management Component', () => {
        let comp: HappyHourComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HappyHourComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.happyHours[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
