...
import { FoodItemsComponent } from 'app/entities/jmenuback/food-items/food-items.component';
...
describe('Component Tests', () => {
    describe('FoodItems Management Component', () => {
        let comp: FoodItemsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FoodItemsComponent, '')
                .compileComponents();
